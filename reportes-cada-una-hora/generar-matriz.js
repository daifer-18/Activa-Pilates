...
console.log('🚀 Generando reporte tipo matriz...\n');

// Paso 1: Ejecutar las pruebas y guardar el JSON
console.log('📝 Ejecutando pruebas...');
let jsonOutput;
try {
    jsonOutput = execSync('npx playwright test pruebas.spec.ts --reporter=json', {
        encoding: 'utf-8',
        maxBuffer: 10 * 1024 * 1024 // 10MB buffer
    });
} catch (error) {
    // Si hay errores en los tests, el output aún está disponible
...
// Guardar JSON limpio
fs.writeFileSync('reporte-clean.json', jsonOutput, 'utf-8');

// Parsear el JSON
const reporteJSON = JSON.parse(jsonOutput);

// Extraer información relevante
const suites = reporteJSON.suites;
...
console.log('\n✅ Reporte tipo matriz generado exitosamente!');
console.log(`📄 Archivo: reporte-matriz.html`);
